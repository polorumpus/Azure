...
# https://docs.microsoft.com/en-us/azure/virtual-machines/windows/spot-powershell
# Create a virtual machine configuration using spot instance
$vmConfigSpotInstance = New-AzVMConfig -VMName $vmName -VMSize Standard_D4s_v3 -Priority "Spot" -MaxPrice -1 -EvictionPolicy Deallocate | `
...
# Create a virtual machine either using spot instance 
New-AzVM -ResourceGroupName $resourceGroup -Location $location -VM $vmConfigSpotInstance